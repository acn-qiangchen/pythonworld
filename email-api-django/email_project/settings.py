"""
Django settings for email_project.
"""
import os
...
# Database - Using SQLite for simplicity (can be changed to PostgreSQL/MySQL)
DATABASES = {
    'default': {
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 100,
    'EXCEPTION_HANDLER': 'email_api.exceptions.custom_exception_handler',
}
